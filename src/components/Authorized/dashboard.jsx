...
const BikeRentalDashboard = () => {
  ...
  const activeRentals = recentBookings.filter(
    (booking) => booking.status === "active"
  ).length;
  const availableBikes = bikeInventory.reduce(
    (sum, bike) => sum + bike.available,
    0
  );
      ...
      <div className="flex">
        ...
        <div className="w-64 bg-base-200 h-screen">
          <ul className="menu p-4 text-base-content">
            ...
            <li>
              <a onClick={goToBooking} className="font-medium">
                Bookings
              </a>
            </li>
            <li >
            ...
            <li >
              <a className="font-medium">Settings</a>
            </li>
          </ul>
        </div>
